...
const Review = ({ reviewer, score, content, date, imgUrl }) => {
  ...
  return (
    <div className="review-container flex w-[790px] h-[227px] p-6 rounded-lg border border-gray-100 bg-white">
      {/* 왼쪽 컨테이너 */}
      <div className="left-container flex flex-col gap-[12px] flex-grow">
        ...
        <div className="review-content flex flex-col h-full">
          <div className="reviewer text-lg font-semibold mb-[8px]">
            {reviewer}
          </div>
          <div className="content text-base mb-2">{content}</div>
          <div className="date text-sm text-gray-500 mt-auto mb-[8px]">
            {date}
          </div>
        </div>
      </div>
