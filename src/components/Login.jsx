  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="absolute inset-0 flex justify-end items-center pr-4">
        <div className="relative z-10 max-w-md w-full bg-white rounded-lg shadow-md p-8 ml-4 self-center">
        ...
        <div
          className="w-2/3 h-full bg-cover bg-right opacity-80 bg-blue-200"
